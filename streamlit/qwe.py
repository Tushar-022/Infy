...
body = {
    ...
    "system": (
        "Analyze the provided image based on data and values it has, predict possible disease conditions based on values in the report and generate 4-5 questions related to the possible condition to confirm the disease. "
            ...
            "content": [
                {
                    ...
                    "source": {
                        ...
                        "data": get_base64_encoded_image("./blood12.png")
                    },
                },
            ],
        },
...
# Sending user responses for disease confirmation
followup_body = {
    "anthropic_version": "bedrock-2023-05-31",
    "system": (
